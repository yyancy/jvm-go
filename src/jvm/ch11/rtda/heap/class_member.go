...
import "go-jvm/src/jvm/ch11/classfile"
...
func (self *ClassMember) SetClass(class *Class) {
  self.class = class
}

func (self *ClassMember) SetDescriptor(descriptor string) {
  self.descriptor = descriptor
}

func (self *ClassMember) SetName(name string) {
  self.name = name
}
...
func (self *ClassMember) SetAccessFlags(accessFlags uint16) {
