...
func mapLibraryName(frame *rtda.Frame) {
  ...
  //jlSysClass := classLoader.LoadClass("java/lang/Object")
  //initSysClass := jlSysClass.GetStaticMethod("registerNatives", "()V")
  //base.InvokeMethod(frame, initSysClass)

  ref := frame.LocalVars().GetRef(0)
  str := heap.GoString(ref)
  fmt.Printf("dll: %s", str)
  str = str + ".dll"
...
func checkArrayCopy(src, dest *heap.Object) bool {
  ...
  if
  srcClass.ComponentClass().IsPrimitive() ||
...
func _sysProps() map[string]string {
  return map[string]string{
    ...
    "java.library.path":    "E:/Program Files/java/jdk1.8.0_152/jre/bin",
    //"sun.boot.library.path":    "E:/Program Files/java/jdk1.8.0_152/jre/bin",
  }
}
